...
Il primo passo consiste nel generare la chiave privata e quella pubblica. Tutta la seguente procedura viene effettuata solo su un dispositivo.
 \begin{itemize}
	\item vengono scelti due numeri primi molto grandi con lunghezza simile e ne viene eseguito il prodotto \( n = p*q \), n sarà il modulo utilizzato nell' algoritmo di codifica/decodifica
